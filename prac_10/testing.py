...
def convert_phrase_to_sentence(phrase):
    """
    Convert a phrase into a sentence by capitalizing the first letter and ensuring it ends with a period.
    >>> convert_phrase_to_sentence('hello')
    'Hello.'
    >>> convert_phrase_to_sentence('It is an ex parrot.')
    'It is an ex parrot.'
    >>> convert_phrase_to_sentence('this is a test.')
    'This is a test.'
    >>> convert_phrase_to_sentence('This is. another. test')
